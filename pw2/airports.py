...
print(f" * closeness centrality:         {closeness_centrality(G, v, attr='Distance'):.3f}")
print(f" * betweenness centrality:       {betweenness_centrality(G, v, attr='Distance')}")
print(f" * network density:              {network_density(G):.3f}")
print(f" * network diameter:             {network_diameter(G, attr='Distance'):.3f}")
print(f" * network average path length:  {network_avg_path_len(G, attr='Distance'):.3f}")